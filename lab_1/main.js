window.onload = function(event) {
  ...
  globalGain = audioContext.createGain(); //this will control the volume of all notes
  globalGain.gain.setValueAtTime(0.8, audioContext.currentTime);
  ...
  console.log("glbl gain", globalGain.gain.value);
}
